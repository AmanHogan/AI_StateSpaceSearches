...
def a_s(initial_state, goal_state, arguments, dump_flag):
    ...
    while fringe:
        ...
        # Sort the fringe based on f(n)
        fringe.sort(key=lambda x: n.heuristic_1(x, goal_state) + x.cum_cost)
        ...
        # Return goal - state and close output file
        ...
        # Expand node and generate children nodes
        ...
        for next_node in node.children:
            ...
            if tuple(next_node.state) not in visited:
                ...
                # Update path, cumulative path, relative cost AND node depth of the 'next_node'
